...
namespace MagicVilla_VillaApi.Migrations
{
    ...
    [Migration("20221004092916_AddForeignFeyToVillaTable")]
    partial class AddForeignFeyToVillaTable
    {
            ...
            modelBuilder.Entity("MagicVilla_VillaApi.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 4, 13, 29, 16, 455, DateTimeKind.Local).AddTicks(430),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 4, 13, 29, 16, 455, DateTimeKind.Local).AddTicks(441),
                            Details = "chgitem inch chgitem vonc",
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 4, 13, 29, 16, 455, DateTimeKind.Local).AddTicks(442),
                            Details = "chgitem inch chgitem vonc",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 4, 13, 29, 16, 455, DateTimeKind.Local).AddTicks(444),
                            Details = "chgitem inch chgitem vonc",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 4, 13, 29, 16, 455, DateTimeKind.Local).AddTicks(445),
                            Details = "chgitem inch chgitem vonc",
