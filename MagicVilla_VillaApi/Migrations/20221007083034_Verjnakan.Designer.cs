...
namespace MagicVilla_VillaApi.Migrations
{
    ...
    [Migration("20221007083034_Verjnakan")]
    partial class Verjnakan
    {
            ...
            modelBuilder.Entity("MagicVilla_VillaApi.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 7, 12, 30, 34, 18, DateTimeKind.Local).AddTicks(9487),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 7, 12, 30, 34, 18, DateTimeKind.Local).AddTicks(9498),
                            Details = "chgitem inch chgitem vonc",
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 7, 12, 30, 34, 18, DateTimeKind.Local).AddTicks(9499),
                            Details = "chgitem inch chgitem vonc",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 7, 12, 30, 34, 18, DateTimeKind.Local).AddTicks(9500),
                            Details = "chgitem inch chgitem vonc",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 7, 12, 30, 34, 18, DateTimeKind.Local).AddTicks(9501),
                            Details = "chgitem inch chgitem vonc",
