...
namespace MagicVilla_VillaApi.Migrations
{
    ...
    [Migration("20221010143745_AddUserToDb")]
            ...
            modelBuilder.Entity("MagicVilla_VillaApi.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 10, 18, 37, 45, 323, DateTimeKind.Local).AddTicks(9475),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 10, 18, 37, 45, 323, DateTimeKind.Local).AddTicks(9488),
                            Details = "chgitem inch chgitem vonc",
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 10, 18, 37, 45, 323, DateTimeKind.Local).AddTicks(9489),
                            Details = "chgitem inch chgitem vonc",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 10, 18, 37, 45, 323, DateTimeKind.Local).AddTicks(9490),
                            Details = "chgitem inch chgitem vonc",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 10, 18, 37, 45, 323, DateTimeKind.Local).AddTicks(9491),
                            Details = "chgitem inch chgitem vonc",
