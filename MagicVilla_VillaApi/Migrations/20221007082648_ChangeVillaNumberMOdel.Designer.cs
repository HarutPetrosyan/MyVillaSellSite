...
namespace MagicVilla_VillaApi.Migrations
{
    ...
    [Migration("20221007082648_ChangeVillaNumberMOdel")]
    partial class ChangeVillaNumberMOdel
    {
            ...
            modelBuilder.Entity("MagicVilla_VillaApi.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 7, 12, 26, 48, 288, DateTimeKind.Local).AddTicks(9839),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 7, 12, 26, 48, 288, DateTimeKind.Local).AddTicks(9851),
                            Details = "chgitem inch chgitem vonc",
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 7, 12, 26, 48, 288, DateTimeKind.Local).AddTicks(9853),
                            Details = "chgitem inch chgitem vonc",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 7, 12, 26, 48, 288, DateTimeKind.Local).AddTicks(9855),
                            Details = "chgitem inch chgitem vonc",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreatedDate = new DateTime(2022, 10, 7, 12, 26, 48, 288, DateTimeKind.Local).AddTicks(9857),
                            Details = "chgitem inch chgitem vonc",
